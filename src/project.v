//\section*{Appendix A: VGA Playground Example Code}
//\addcontentsline{toc}{section}{Appendix A: VGA Playground Example Code}

//Copy this file to \texttt{src/project.v} in your \texttt{ttihp-verilog-template} repository.
//Rename \texttt{tt\_um\_yourname\_vga\_stripes} to include your GitHub username.
//Set \texttt{clock\_hz: 25000000} in \texttt{info.yaml}.

//See the \textbf{MODIFY THIS SECTION} block to change colours, direction, and stripe width.

//\bigskip

//\begin{lstlisting}[language=Verilog, caption={VGA Animated Stripes --- src/project.v}]
